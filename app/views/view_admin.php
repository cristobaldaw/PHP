...
$num_total_registros = TotalOfertas()['total'];
...
<body>
  ...
  <p class="lead">
    <a href="../controllers/ctr_anadir.php"><button type="button" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"> Añadir nueva oferta</i></button></a>
  </p>
</div>
